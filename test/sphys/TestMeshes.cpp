...
std::pair<HalfEdgeMesh, stdext::PackedVector<glm::vec3>> createTestMesh1()
{
	HalfEdgeMesh meshData;
	stdext::PackedVector<glm::vec3> normals;
...
std::pair<HalfEdgeMesh, stdext::PackedVector<glm::vec3>> createTestMesh2()
{
	HalfEdgeMesh meshData;
	stdext::PackedVector<glm::vec3> normals;
...
std::pair<HalfEdgeMesh, stdext::PackedVector<glm::vec3>> createTestMesh4()
{
	HalfEdgeMesh meshData;
	stdext::PackedVector<glm::vec3> normals;
