#ifndef SPHYS_RIGID_BODY_WORLD_H
#define SPHYS_RIGID_BODY_WORLD_H
...
namespace sphys {
	...
	public:		// Functions
		...
		stdext::ThreadPool& getThreadPool()
		{ return mThreadPool; };
...
#endif		// SPHYS_RIGID_BODY_WORLD_H
